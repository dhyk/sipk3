 							...
 							<div class="card-box">
 								...
 								<div class="row">
 									<div class="col-md-12">
										 ...
										 <form action="<?php echo base_url().'index.php/K3listrik/simpan_teknisi';?>" method="post" >
 											<div class="form-group">
 												<label class="col-md-2 control-label">Nama Teknisi K3 Listrik</label>
 												<div class="col-md-10">
 													<input type="text" class="form-control" placeholder="Masukkan Nama Nama Teknisi K3 Listrik" name="nama" required><br><?//php echo form_error('judul'); ?>
 												</div>
 											</div>
											...
											<br>
 											<div class="form-group m-b-0">
 												<div class="col-sm-offset-10 col-sm-12">
 													...
 													<?php //echo form_close(); ?>
 													<a href="<?php echo site_url()?>K3listrik/teknisi"><button type="button" class="btn btn-danger">Kembali</button></a>
