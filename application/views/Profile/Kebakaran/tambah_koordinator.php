 								...
 								<div class="row">
 									<div class="col-md-12">
 										...
 										<!-- <form class="form-horizontal" enctype="multipart/form-data" action="<?php //echo base_url().'index.php/Admin/tambahberita'; ?>" method="post"> -->
 											<?php echo form_open_multipart('index.php/Kebakaran/simpan_kebakaran_penanggulangan');?>
 												...
 												<div class="form-group m-b-0">
 													...
 													<div class="col-md-10">
 														<div class="input-group">
 															...
 															<span class="help-block"><small>Sertifikat kursus teknis penanggulangan kebakaran tingkat dasar II (Max 2MB)</small></span>
 														</div>
 													</div>
 												</div>
 											</div>
											...
											<br>
 											<div class="form-group m-b-0">
 												<div class="col-sm-offset-10 col-sm-12">
 													...
 													<?php //echo form_close(); ?>
 													<a href="<?php echo site_url()?>Kebakaran/koordinator"><button type="button" class="btn btn-danger">Kembali</button></a>
