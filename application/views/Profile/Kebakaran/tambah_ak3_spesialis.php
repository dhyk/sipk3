 								...
 								<div class="row">
 									<div class="col-md-12">
 										...
 										<!-- <form class="form-horizontal" enctype="multipart/form-data" action="<?php //echo base_url().'index.php/Admin/tambahberita'; ?>" method="post"> -->
 											<?php echo form_open_multipart('index.php/Kebakaran/simpan_kebakaran_ak3');?>
 											<div class="form-group">
 												<label class="col-md-2 control-label">Nama A3 Spesialis</label>
 												<div class="col-md-10">
 													<input type="text" class="form-control" placeholder="Masukkan Nama A3 Spesialis" name="nama" required><br><?//php echo form_error('judul'); ?>
 												</div>
 											</div>
											...
											<br>
 											<div class="form-group m-b-0">
 												<div class="col-sm-offset-10 col-sm-12">
 													...
 													<?php //echo form_close(); ?>
 													<a href="<?php echo site_url()?>Kebakaran/ak3"><button type="button" class="btn btn-danger">Kembali</button></a>
