            ...
            <div class="card-header">
                ...
                <div class="tabs">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab2" data-toggle="tab" href="#tabProfile2" role="tab" aria-controls="home" aria-selected="true">Masyarakat</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="contact-tab2" data-toggle="tab" href="#tabBilling2" role="tab" aria-controls="contact" aria-selected="false">Perusahaan</a>
                        </li>
                    </ul>
                </div>
            </div>
