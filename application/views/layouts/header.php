...
<html lang="en">
    ...
    <head>
        ...
        <link
            rel="icon"
            type="image/png"
            href="<?php echo base_url()?>assets/images/favicon22.png">
        ...
        <script
            src="<?php echo base_url()?>assets/js_new/sweetalert/dist/sweetalert2.all.min.js"></script>
        <link
    ...
    <body>
        ...
        <section
            class="parallax fullscreen"
            style="background: url('<?php echo base_url()?>assets/images/11.jpg')">
...
<div
    ...
    <div class="widget widget-form p-cb text-center">
        <img
            src="<?php echo base_url()?>assets/images/favicon22.png"
            class="feature-icon text-center">
        <p align="center">
        ...
        <form
            action="<?php echo base_url(). 'index.php/Home/login_check'; ?>"
            method="post"
            name="login">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        aria-selected="false">Username & Password</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a
                                        ...
                                        role="tab"
                                        aria-controls="home"
                                        aria-selected="true">Data Perusahaan</a>
                                </li>
                                <li class="nav-item">
                                    <a
                                        class="nav-link"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input
                                                ...
                                                class="form-control"
                                                id="nomor_p2k3"
                                                placeholder="Masukkan Nomor P2K3"
                                                value=""
                                                required="required">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input
                                                ...
                                                class="form-control"
                                                id="tanggal_p2k3"
                                                placeholder="Masukkan Tanggal Pengesahan P2K3"
                                                value=""
                                                required="required">
                                        </div>
                                    </div>
