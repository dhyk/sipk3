                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <br />
                            <div class="card-box">
                                <h4 class="header-title m-t-0 m-b-30">Daftar Elevator dan Eskalator<span class="help-block"><small>*Pastikan Data yang anda masukkan benar</small></span></h4>
                                                        ...
                                                        $i=1;
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td>
                                                                  ...
                                                                  <a href="<?php echo base_url().'index.php/K3mekanik/hapus_elevator?id='.$key->id_elevator;?>"><i class="ion-trash-a"></i>Hapus</a>
                                                              </td>
