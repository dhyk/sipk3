 					...
 					<div class="row">
 						<div class="col-sm-12">
 							<div class="card-box">
 								...
 								<h4 class="m-t-0 header-title"><b>Tambah Sertifikat Produk</b></h4>
 								<div class="row">
 									<div class="col-md-12">

 										<!-- <form class="form-horizontal" enctype="multipart/form-data" action="<?php //echo base_url().'index.php/Admin/tambahberita'; ?>" method="post"> -->
 											<?php echo form_open_multipart('index.php/Admin/aksi_tambah_sertifikat_produk');?>
 											<div class="form-group">
 												<label class="col-md-2 control-label">Nama Sertfikat Produk</label>
 												<div class="col-md-10">
 		
 													<input type="text" class="form-control" placeholder="Masukkan Nama Sertfikat Produk" name="nama" required>
                                    		...
                                    		<div class="">
		 											...
		 											<div class="form-group">
		                                                  ...
		                                                  <div class="col-md-10">
		                                                  <div class="input-group"> 
		                                                  	<input type="date" class="form-control" placeholder="mm/dd/yyyy" id="datepicker" required name="masa">
		                                                     <span class="input-group-addon bg-custom b-0"><i class="mdi mdi-calendar text-white"></i></span>
		                                                   </div>
		                                                   <br><!-- input-group -->
		                                                   </div>
