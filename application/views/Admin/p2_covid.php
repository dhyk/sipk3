                        ...
                        <div class="col-md-12">
                            <div class="card-box">
                                ...
                                <table class="tablesaw m-t-20 table m-b-0" data-tablesaw-mode="stack">
                                        <thead>
                                            <tr>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3" >No</th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Indikator Penilaian</th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" >Pertanyaan</th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" colspan="2">Jawab</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
