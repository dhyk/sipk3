 							...
 							<div class="card-box">
 								...
 								<div class="row">
 									<div class="col-md-12">
										 ...
										 <form action="<?php echo base_url().'index.php/K3listrik/simpan_ijin_listrik';?>" method="post" >
											...
											<br>
 											<div class="form-group m-b-0">
 												<div class="col-sm-offset-10 col-sm-12">
 													...
 													<?php //echo form_close(); ?>
 													<a href="<?php echo site_url()?>K3listrik/izin_listrik"><button type="button" class="btn btn-danger">Kembali</button></a>
