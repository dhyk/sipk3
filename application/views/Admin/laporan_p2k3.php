                ...
                <div class="table-responsive">
                        ...
                        <div class="form-group m-b-0">
 												<div class="col-sm-offset-0 col-sm-12">
                                                     <a target="_blank" href="<?php echo base_url()."upload/template_p2k3/Laporan-P2K3-Template.doc" ?>"><button class="btn btn-orange waves-effect waves-light "><i class="glyphicon glyphicon-cloud-download"></i> Download Template Laporan</button></a>
