							...
							<div class="row">
								<div class="col-md-12">
									...
									<!-- <form class="form-horizontal" enctype="multipart/form-data" action="<?php //echo base_url().'index.php/Admin/tambahberita'; ?>" method="post"> -->
										<?php echo form_open_multipart('index.php/Kebakaran/simpan_kebakaran_gladi');?>
										<div class="form-group">
											<label class="col-md-2 control-label">Nama Pelatihan / Gladi</label>
											<div class="col-md-10">
												<input type="text" class="form-control" placeholder="Masukkan Nama Pelatihan" name="nama" required><br><?//php echo form_error('judul'); ?>
											</div>
										</div>
									   ...
									   <br>
										<div class="form-group m-b-0">
											<div class="col-sm-offset-10 col-sm-12">
												...
												<?php //echo form_close(); ?>
												<a href="<?php echo site_url()?>Kebakaran/gladi"><button type="button" class="btn btn-danger">Kembali</button></a>
