 								...
 								<div class="row">
 									<div class="col-md-12">
 										...
 										<!-- <form class="form-horizontal" enctype="multipart/form-data" action="<?php //echo base_url().'index.php/Admin/tambahberita'; ?>" method="post"> -->
 											<?php echo form_open_multipart('index.php/Admin/aksi_tambah_ahlik3');?>
 											<div class="form-group">
 												<label class="col-md-2 control-label">Nama Sertfikat Ahli K3 Umum</label>
 												<div class="col-md-10">
 		
 													<input type="text" class="form-control" placeholder="Masukkan Nama Ahli K3 Umum" name="nama" required>
 											...
 											<div class="form-group">
 												<label class="col-md-2 control-label">Nomor Sertfikat Ahli K3 Umum</label>
 												<div class="col-md-10">
 		
 													<input type="text" class="form-control" placeholder="Masukkan Nomor Ahli K3 Umum" name="nomor" required>
 													<!-- <span class="help-block"><small>*Lengkapi dengan kode SNI</small></span> -->
 													<br>
 												</div>
 											</div>
