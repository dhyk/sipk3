...
class ProK3mekanik extends CI_Controller {
  ...
  public function bejana()
  {
    ...
    $data = [
      ...
      'content' => 'Profile/k3_mekanik/a_bejana',
      'footer' => 'Profile/Layouts_admin/footer',
     'data_bejana'=> $this->M_mekanik->lihat_bejana($this->session->userdata('id_perusahaan'))->result(),
  ...
  public function ketel()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/k3_mekanik/b_ketel',
      'footer' => 'Profile/Layouts_admin/footer',
      'data_ketel'=> $this->M_mekanik->lihat_ketel($this->session->userdata('id_perusahaan'))->result(),
  ...
  public function tenaga()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/k3_mekanik/c_tenaga',
      'footer' => 'Profile/Layouts_admin/footer',
     'data_mesin'=> $this->M_mekanik->lihat_mesin($this->session->userdata('id_perusahaan'))->result(),
  ...
  public function elevator()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/k3_mekanik/d_elevator',
      'footer' => 'Profile/Layouts_admin/footer',
     'data_elevator'=> $this->M_mekanik->lihat_elevator($this->session->userdata('id_perusahaan'))->result(),
  ...
  public function alatukur()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/k3_mekanik/e_alatukur',
      'footer' => 'Profile/Layouts_admin/footer',
      'data_ukur'=> $this->M_mekanik->lihat_ukur($this->session->userdata('id_perusahaan'))->result(),
  ...
  public function alatangkat()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/k3_mekanik/f_alatangkut',
      'footer' => 'Profile/Layouts_admin/footer',
      'data_alat_angkat'=> $this->M_mekanik->lihat_angkat($this->session->userdata('id_perusahaan'))->result(),
  ...
  public function tambah_mesin()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/K3_Mekanik/tambah_mesin',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
...
//echo 'Masuk ah';
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/K3_Mekanik/tambah_bejana',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
    // var_dump($data);
  ...
  public function tambah_alat_angkat()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/K3_Mekanik/tambah_alat_angkat',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_alat_ukur()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/K3_Mekanik/tambah_alat_ukur',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_elevator_eskalator()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/K3_Mekanik/tambah_elevator_eskalator',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_ketel_uap()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/K3_Mekanik/tambah_ketel_uap',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
