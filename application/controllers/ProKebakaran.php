...
class ProKebakaran extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data = [
      ...
      'content' => 'Profile/Kebakaran/a_pencegahan_dan _penanggulangan_kebakaran',
  ...
  public function petugas()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/b_petugas_kebakaran',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function tambah_petugas_kebakaran()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_petugas_kebakaran',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function koordinator()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/c_koordinator_unit',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function ak3()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/d_ak3',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function gladi()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/e_gladi',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function apar()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/f_apar',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function alarm()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/g_alarm',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function hydrant()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/h_hydrant',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function sprinkler()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/i_sprinkler',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function instalasi()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/j_instalasi',
      'footer' => 'Profile/Layouts_admin/footer',
  ...
  public function tambah_ak3_spesialis()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_ak3_spesialis',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_izin_instalasi_pemadam()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_izin_instalasi_pemadam',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_koordinator()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_koordinator',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_rekaman_apar()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_rekaman_apar',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_rekaman_instalasi_alarm()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_rekaman_instalasi_alarm',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_rekaman_instalasi_fire()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_rekaman_instalasi_fire',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_rekaman_instalasi_sprinkler()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_rekaman_instalasi_sprinkler',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function tambah_rekaman_latihan()
  {
    ...
    $data = [
      ...
      'akun' => $this->session->userdata('username'),
      'level' => $this->session->userdata('level'),
      'content' => 'Profile/Kebakaran/tambah_rekaman_latihan',
      'footer' => 'Profile/Layouts_admin/footer',
    ];
  ...
  public function simpan_kebakaran_utama()
  {
    ...
    if (($penanggulangan != null) && ($kerja != null) && ($regu != null)) {
      ...
      $this->M_kebakaran->simpan_kebakaran_utama($data,$this->session->userdata('id_perusahaan'));
